            ...
            match &params.usecols{
                Some(x) =>{
                    results.results.extend({
                            x.iter().map(|y| u8::from_str(line_split_vec[*y].trim()).unwrap())
                        });
                }
                None =>{
                    results.results.extend({
                        line_split_vec.iter().map(|x| u8::from_str(x.trim()).unwrap())
                    });
                }
            }
        }
    ...
    while reader.read_line(&mut line).unwrap() > 0{
        ...
        if !line.starts_with(&comment){
            ...
            match &params.usecols{
                Some(x) =>{
                    results.results.extend({
                            x.iter().map(|y| u16::from_str(line_split_vec[*y].trim()).unwrap())
                        });
                }
                None =>{
                    results.results.extend({
                        line_split_vec.iter().map(|x| u16::from_str(x.trim()).unwrap())
                    });
                }
            }
        }
    ...
    while reader.read_line(&mut line).unwrap() > 0{
        ...
        if !line.starts_with(&comment){
            ...
            match &params.usecols{
                Some(x) =>{
                    results.results.extend({
                            x.iter().map(|y| u32::from_str(line_split_vec[*y].trim()).unwrap())
                        });
                }
                None =>{
                    results.results.extend({
                        line_split_vec.iter().map(|x| u32::from_str(x.trim()).unwrap())
                    });
                }
            }
        }
    ...
    while reader.read_line(&mut line).unwrap() > 0{
        ...
        if !line.starts_with(&comment){
            ...
            match &params.usecols{
                Some(x) =>{
                    results.results.extend({
                            x.iter().map(|y| u64::from_str(line_split_vec[*y].trim()).unwrap())
                        });
                }
                None =>{
                    results.results.extend({
                        line_split_vec.iter().map(|x| u64::from_str(x.trim()).unwrap())
                    });
                }
            }
        }
    ...
    while reader.read_line(&mut line).unwrap() > 0{
        ...
        if !line.starts_with(&comment){
            ...
            match &params.usecols{
                Some(x) =>{
                    results.results.extend({
                            x.iter().map(|y| u128::from_str(line_split_vec[*y].trim()).unwrap())
                        });
                }
                None =>{
                    results.results.extend({
                        line_split_vec.iter().map(|x| u128::from_str(x.trim()).unwrap())
                    });
                }
            }
        }
    ...
    while reader.read_line(&mut line).unwrap() > 0{
        ...
        if !line.starts_with(&comment){
            ...
            match &params.usecols{
                Some(x) =>{
                    results.results.extend({
                            x.iter().map(|y| usize::from_str(line_split_vec[*y].trim()).unwrap())
                        });
                }
                None =>{
                    results.results.extend({
                        line_split_vec.iter().map(|x| usize::from_str(x.trim()).unwrap())
                    });
                }
            }
        }
